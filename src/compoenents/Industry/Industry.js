...
const Industry = () => {
    return (
        ...
        <div className="Academics">
          ...
          <div>
            <h1> Reap the value of AI through our Capability building Platform
 </h1><br /> <br />
           <p> Ensuring future readiness of your Organization through requisite AI capabilities of 
your team!
</p><br />
           <Button1 
